...
public abstract class AbstractAccountGui extends GuiScreen
{
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(3, this.width / 2 + 2, this.height - 28, 150, 20, I18n.format("Cancel")));
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		this.drawCenteredString(fontRenderer, I18n.format("Username"), this.width / 2 - 130, 66, -1);
		this.drawCenteredString(fontRenderer, I18n.format("Password"), this.width / 2 - 130, 96, -1);
